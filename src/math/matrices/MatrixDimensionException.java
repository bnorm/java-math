...
/**
 * An unchecked exception for when a matrix dimension error occurs.  This error could occur when trying to access part
 * of a matrix that does not exist or multiplying two matrices together who's dimensions do not agree.
 *
 * @author Brian Norman
 * @version 0.1 beta
 */
public class MatrixDimensionException extends RuntimeException {
   ...
   /**
    * Creates a {@code MatrixDimensionException} with the specified detail message.
    *
